...
# Point history classifier class for classifying dynamic gestures, taking in history list of landmark points
class PointHistoryClassifier(object):
  ...
  def __call__(self, point_history):
    # classify the point history as outputs a corresponding index integer
